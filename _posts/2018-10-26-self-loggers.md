...
I hope that documenting and sharing my own process might help make it less mysterious and more approachable for students who are unfamiliar with the annals of academia.TODO
Plus, *anticipating* reflecting on the usefulness and self-growth --- through the magic of [preemptive retrospection](https://scholarsarchive.byu.edu/etd/1688), I hope that viewing the challenge as much as possible as an opportunity for personal growth instead of as a harrowing, arbitrary hoop to jump through.
...
Sitting down to write a paragraph about pretty much anything can make you realize *something* meaningful about it.
Usually, I start hacking out a reflection like "Sure, that's a bunch of B.S. bit of a reach" but then this weird thing happens where, a few minutes or months later, I believe it.

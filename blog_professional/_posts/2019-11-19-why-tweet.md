...
The awesome [@vsoch](https://twitter.com/vsoch) (twitter bio: I'm the Vanessasaurus!) reached out of nowhere and helped [set up a Docker build](https://github.com/mmore500/presentation-template/pull/1) and [CircleCI tests](https://github.com/mmore500/presentation-template/pull/4) for the project.
...
Basically, I smooshed together two pre-existing projects and then commented out the lines that threw errors.
(A+ quality cargo cult programming!)
Once I got it (minimally) working, I tweeted it out.
...
To my surprise, a few hours later I got a direct message from the CEO of [Sylabs](https://sylabs.io/), the [Singularity project's](https://github.com/sylabs/singularity) spin-off start-up company.
It turns out that checkpointing containers was an objective on their development road map.

...
supporting_materials: |
  ...
  - [*Overlapped Area Chart with Zoom Outsets*](https://python-graph-gallery.com/web-overlapped-area-chart-with-zoom-outsets/), example via [Python Graph Gallery](https://python-graph-gallery.com/)
  - [*Scatterplot with Categorical Zoom Facets*](https://python-graph-gallery.com/web-scatterplot-with-categorical-zoom-facets/), example via [Python Graph Gallery](https://python-graph-gallery.com/)
---
